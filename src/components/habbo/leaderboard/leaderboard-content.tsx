...
export default function LeaderboardContent() {
  ...
  const { leaderboard, isLoading, error, nextUpdateIn, updateInterval, totalPages } = useLeaderboardData(
    currentPage,
    perPage,
  );
  ...
  return (
    <>
      ...
      <LeaderboardPagination currentPage={currentPage} totalPages={totalPages} setCurrentPage={setCurrentPage} />
    </>
  );
}
